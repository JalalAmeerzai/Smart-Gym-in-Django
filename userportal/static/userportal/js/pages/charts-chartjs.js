...
$(document).ready(function() {
	...
	var lineDotsData = {
		...
		datasets : [
			{
				label: "PayPal",
				fillColor : "rgba(124, 179, 66,.2)",
				strokeColor : "rgba(124, 179, 66,1)",
				pointColor : "rgba(124, 179, 66,1)",
				pointStrokeColor : "#fff",
				pointHighlightFill : "#fff",
				pointHighlightStroke : "rgba(223,106,120,1)",				
				data : [1+randNum(),2+randNum(),3+randNum(),4+randNum(),17+randNum(),21+randNum(),3+randNum()]
			},
			{
				label: "Credit card",
				fillColor : "rgba(96,177,204,0.2)",
